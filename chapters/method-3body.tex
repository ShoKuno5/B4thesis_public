...
\label{sec:3body-critical}
    ...
    \begin{align}
        ...
        &=\frac{\pi}{2}+\operatorname{sgn}(\Omega)\tau-|\Omega| k\left(\frac{2a}{\Omega}\operatorname{sgn}(\Omega)\sin\tau+\frac{\tau}{|\Omega|}\sin z+\frac{\omega \tau^2}{2|\Omega|^2}\cos z\right)+O(k^2,\varepsilon^2k).\label{eq:x-series}
    \end{align}
    ...
    \end{equation}
    となる．
    式\eqref{eq:pertu-ytilde}を両辺$\tau$で微分すると，$\ast'\coloneqq\dd{\ast}/\dd{\tau}$として，以下が得られる．
    \begin{align}
    ...
    \begin{align}
        \begin{split}
            ...
            -&\ 2a^2\sin^2(\tau+s)-a(\tau+s)\sin (\tau+s)\sin (z+\varepsilon s)\\
            -&\ \frac{a\varepsilon (\tau+s)^2}{2}\sin (\tau+s) \cos (z+\varepsilon\tau)-\pt_s h_2+O(\varepsilon^2)\\
    ...
    \begin{equation}
        z'=\varepsilon-2k\sin z+O(k^2,\varepsilon k,\varepsilon k\tau)
    ...
    \begin{align}
        ...
        \begin{split}
            z'&=\varepsilon-2k\sin z-k^2a(a-\sin  z)+O(k^3,\varepsilon k,\varepsilon k\tau)\\
            &=\varepsilon-a^2k^2-k(2-ak)\sin z+O(k^3,\varepsilon k,\varepsilon k\tau).
        \end{split}
    \end{align}
    $z$が安定解を持つ条件は，
    \begin{align}
